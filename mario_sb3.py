...
def train(env, dir, timesteps, verbose=1, policy="CnnPolicy", lr=.003, ns=8, bs=128, ne=12,gamma=.99, gae_lambda=.95):
    model = PPO("CnnPolicy", env=env, learning_rate=lr, n_steps=ns, batch_size=bs, n_epochs=ne,gamma=gamma, gae_lambda=gae_lambda, verbose=verbose)
...
if __name__ == "__main__":
    ...
    n_side = 84
    n_stack = 4
    env1 = load_smb_env_blind(obs_complexity=0, n_side = n_side, n_stack = n_stack, n_skip=4)
